...
const TransportForm: React.FC = () => {
  ...
  const [isInvalidPackageDetail, setIsInvalidPackageDetail] = useState(false);
                ...
                <>
                  ...
                  <DeliveryAddress
                    ...
                    setSelectedSubDistrictName={
                      setSelectedSubDistrictNameSender
                    }
                ...
                <>
                    ...
                    <Col>
                      <DeliveryAddress
                        ...
                        setSelectedProvinceName={
                          setSelectedProvinceNameReceiver
                        }
                        selectedDistrictName={selectedDistrictNameReceiver}
                        setSelectedDistrictName={
                          setSelectedDistrictNameReceiver
                        }
                    ...
                    <Row>
                      ...
                      <Col className="mb-4" xs={12} sm={6} md={6} lg={6} xl={6}>
                        <TextInput
                          ...
                          onChange={(e) =>
                            handleCCsizeInputChange(e.target.value)
                          }
                  ...
                  <Form className="responsive-label">
                    ...
                    <Form.Control
                      as="textarea"
                      value={packageDetail}
                      placeholder="กรอกรายละเอียดสิ่งของที่ส่ง..."
                      onChange={(e) =>
                        handlePackageDetailInputChange(e.target.value)
                      }
                      ...
                      selectDeliveryType === "ส่งรถกลับบ้าน"
                        ? {
                            ...
                            registrationBookFilePath:
                              selectedRegistrationBookFile, // ส่ง File | null โดยตรง
